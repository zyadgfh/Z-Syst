...
class Paytm
{
    ...
    public static function make_payment($array)
    {
        $paytmParams = [
            ...
            "CALLBACK_URL"    => route('paytm.status', ['merchant_key' => $array['merchant_key'], 'plan_id' => $array['plan_id'], 'gateway_id' => $array['gateway_id'], 'business_id' => $array['business_id']]),
        ];
        ...
        $paytmUrl = $array['mode'] == 1 ? "https://securegw.paytm.in/theia/processTransaction" : "https://securegw-stage.paytm.in/theia/processTransaction";
