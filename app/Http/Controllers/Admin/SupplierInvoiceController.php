...
class SupplierInvoiceController extends Controller
{
    ...
    {
        $payment = SupplierInvoicePayment::where('business_id', (int) $request->user()->business_id)->findOrFail($paymentId);
    ...
    public function createFromPurchase(Request $request): JsonResponse
    {
        ...
        $purchase = \App\Models\Purchase::where('business_id', (int) $request->user()->business_id)->findOrFail($request->purchase_id);
