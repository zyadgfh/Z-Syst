...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('tenant_onboarding_instances')) {
        ...
        if (!Schema::hasTable('welcome_email_templates')) {
        ...
        if (!Schema::hasTable('tenant_checklist_progress')) {
        ...
        if (!Schema::hasTable('onboarding_automation_rules')) {
        ...
        if (!Schema::hasTable('onboarding_analytics')) {
