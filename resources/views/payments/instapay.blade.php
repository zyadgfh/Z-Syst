            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h4 class="payment-title mb-4">{{ __('InstaPay Payment') }}</h4>
                            
                            <div class="alert alert-info">
                                <h5>{{ __('Payment Instructions') }}</h5>
                                <p>{{ __('Please transfer the amount to the following InstaPay ID:') }}</p>
                                <p><strong>{{ $info['merchant_instapay_id'] }}</strong></p>
                            ...
                            <form action="{{ route('instapay.status') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label for="sender_phone">{{ __('Your Phone Number') }} <span class="text-danger">*</span></label>
