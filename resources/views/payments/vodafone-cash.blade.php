            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h4 class="payment-title mb-4">{{ __('Vodafone Cash Payment') }}</h4>
                            
                            <div class="alert alert-info">
                                <h5>{{ __('Payment Instructions') }}</h5>
                                <p>{{ __('Please transfer the amount to the following Vodafone Cash number:') }}</p>
                            ...
                            <form action="{{ route('vodafone-cash.status') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label for="sender_phone">{{ __('Your Vodafone Cash Number') }} <span class="text-danger">*</span></label>
