        ...
        <div class="card">
            <div class="card-bodys">
                <div class="chart-header p-16 border-0 d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ __('Edit Item') }}: {{ $product->productName }}</h4>
                ...
                <div class="p-16">
                    <form action="{{ route('admin.items.update', $product->id) }}" method="POST" id="editItemForm" enctype="multipart/form-data">
                        ...
                        <ul class="nav nav-tabs mb-4" id="editItemTabs" role="tablist">
                            <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-identity" type="button"><i class="fas fa-tag me-1"></i>{{ __('Identity') }}</button></li>
                            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-classification" type="button"><i class="fas fa-layer-group me-1"></i>{{ __('Classification') }}</button></li>
                            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-pricing" type="button"><i class="fas fa-dollar-sign me-1"></i>{{ __('Pricing') }}</button></li>
                            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-inventory" type="button"><i class="fas fa-warehouse me-1"></i>{{ __('Inventory') }}</button></li>
                            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-pharmacy" type="button"><i class="fas fa-pills me-1"></i>{{ __('Pharmacy') }}</button></li>
                        </ul>
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body">
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    <label class="form-check-label">{{ __('Prescription Required') }}</label>
                                                </div>
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    <label class="form-check-label">{{ __('Controlled Item') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" name="product_type">
                                            @foreach(['product' => __('Product'), 'service' => __('Service'), 'combo' => __('Combo')] as $val => $label)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-select" name="tax_type">
                                            <option value="exclusive" {{ old('tax_type', $product->tax_type ?? 'exclusive') == 'exclusive' ? 'selected' : '' }}>{{ __('Exclusive') }}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label"><strong>{{ __('Track Inventory') }}</strong></label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label">{{ __('Allow Negative Stock') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label">{{ __('Track Expiration') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="refrigerated" value="1" {{ old('refrigerated', $product->refrigerated) ? 'checked' : '' }}>
                                            <label class="form-check-label">{{ __('Refrigerated') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">{{ __('Add Quantity') }}</label>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            <a href="{{ route('admin.items.show', $product->id) }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                            <button type="submit" class="btn btn-primary btn-lg" id="saveBtn">
                                <i class="fas fa-save me-2"></i>{{ __('Update Item') }}
                            </button>
                        </div>
                    </form>
                </div>
    ...
    document.getElementById('editItemForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                btn.disabled = false;
                btn.innerHTML = '<i class="fas fa-save me-2"></i>{{ __("Update Item") }}';
                if (data.errors) {
