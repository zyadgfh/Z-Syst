    ...
    <tr>
        <td colspan="6" class="text-center py-5">
            <div class="d-flex flex-column align-items-center">
                <i class="fas fa-store fa-3x mb-3" style="color: #d1d5db;"></i>
                <h5 style="color: #374151; font-weight: 600;">{{ __('No businesses yet') }}</h5>
                <p style="color: #6b7280; font-size: 14px;">{{ __('Businesses will appear here once registered.') }}</p>
            </div>
        </td>
    </tr>
@endforelse
