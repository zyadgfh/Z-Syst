...
@section('main_content')
    <div class="container-fluid" style="padding: 24px; max-width: 720px;">
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 style="font-weight: 700; margin: 0;">كوبون جديد</h4>
        </div>
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST" style="background: #fff; border-radius: 16px; border: 1px solid #e5e5ea; padding: 24px;">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label style="font-size: 12px; font-weight: 600; color: #6e6e73; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; display: block;">كود الكوبون <span style="color: #ff3b30;">*</span></label>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="description" value="{{ old('description') }}" style="width: 100%; border-radius: 10px; border: 1px solid #d2d2d7; padding: 10px 14px; font-size: 15px;" placeholder="خصم صيفي على جميع المنتجات">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" name="value" value="{{ old('value') }}" required step="0.01" min="0.01"
                        style="width: 100%; border-radius: 10px; border: 1px solid #d2d2d7; padding: 10px 14px; font-size: 15px;" placeholder="20">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" name="minimum_order_amount" value="{{ old('minimum_order_amount', 0) }}" step="0.01" min="0"
                        style="width: 100%; border-radius: 10px; border: 1px solid #d2d2d7; padding: 10px 14px; font-size: 15px;" placeholder="0">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" name="maximum_discount_amount" value="{{ old('maximum_discount_amount') }}" step="0.01" min="0"
                        style="width: 100%; border-radius: 10px; border: 1px solid #d2d2d7; padding: 10px 14px; font-size: 15px;" placeholder="غير محدد">
                </div>
                <div class="col-md-6">
