        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-header justify-content-center border-0 text-center d-none d-block d-print-block">
                    <h4 class="mt-2">{{ __('Audit Logs') }}</h4>
                </div>
            </div>
                ...
                <table class="table" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th class="table-header-content">{{ __('User') }}</th>
                            <th class="table-header-content">{{ __('Action') }}</th>
                            <th class="table-header-content">{{ __('Model') }}</th>
                            <th class="table-header-content">{{ __('Description') }}</th>
                            <th class="table-header-content">{{ __('IP Address') }}</th>
                            <th class="table-header-content d-print-none">{{ __('Actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse($logs as $log)
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center">{{ __('No audit logs found.') }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
