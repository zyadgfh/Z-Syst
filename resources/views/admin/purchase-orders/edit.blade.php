                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="priority" name="priority" required>
                                        <option value="normal" {{ $purchaseOrder->priority === 'normal' ? 'selected' : '' }}>Normal</option>
                                        <option value="low" {{ $purchaseOrder->priority === 'low' ? 'selected' : '' }}>Low</option>
                                        <option value="high" {{ $purchaseOrder->priority === 'high' ? 'selected' : '' }}>High</option>
                                        <option value="urgent" {{ $purchaseOrder->priority === 'urgent' ? 'selected' : '' }}>Urgent</option>
                                    </select>
                                    @error('priority')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
