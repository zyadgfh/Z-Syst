...
class ProductPolicyTest extends TestCase
{
    ...
    {
        $this->assertFalse($this->policy->view($this->otherUser, $this->product));
    }
    ...
    {
        $this->assertFalse($this->policy->update($this->otherUser, $this->product));
    }
    ...
    {
        $this->assertFalse($this->policy->delete($this->otherUser, $this->product));
    }

    public function test_update_stock_allows_owner(): void
    {
        $this->assertTrue($this->policy->updateStock($this->user, $this->product));
    }

    public function test_update_stock_denies_non_owner(): void
    {
        $this->assertFalse($this->policy->updateStock($this->otherUser, $this->product));
    }
}
