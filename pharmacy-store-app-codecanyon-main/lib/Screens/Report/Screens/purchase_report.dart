...
class _PurchaseReportState extends State<PurchaseReportScreen> {
  ...
  final PagingController<int, Datas> pageController = PagingController(firstPageKey: 1);
      ...
      appBar: AppBar(
        ...
        actions: [
          Consumer(builder: (context, ref, __) {
            ...
            return personalData.when(data: (business) {
              return GlobalIconButton(
                onPressed: () {
                  if (pageController.itemList!.isNotEmpty) {
                    GeneratePurchasePdf().generatePurchaseReportPdf(context, pageController.itemList, business, _fromDate, _toDate);
                  } else {
