...
class ReportRepo {
  ...
  Future<PurchaseReturnReportModel?> getPurchaseReturnReportList({
    ...
    try {
      ...
      http.Response _response = await http.get(url, headers: headers);
      if (_response.statusCode == 200) {
        final data = PurchaseReturnReportModel.fromJson(jsonDecode(_response.body));
  ...
  Future<SaleReturnReportModel?> getSalesReturnReportList({
    ...
    try {
      ...
      print(_response.body);
      if (_response.statusCode == 200) {
        final data = SaleReturnReportModel.fromJson(jsonDecode(_response.body));
  ...
  Future<IncomeReportModel?> getIncomeReportList({
    ...
    try {
      ...
      print(_response.body);
      if (_response.statusCode == 200) {
        final data = IncomeReportModel.fromJson(jsonDecode(_response.body));
        return data;
      }
  ...
  Future<ExpenseReportModel?> getExpenseReportList({
    ...
    try {
      ...
      print(_response.body);
      if (_response.statusCode == 200) {
        final data = ExpenseReportModel.fromJson(jsonDecode(_response.body));
        return data;
      }
  ...
  Future<DueReportModel?> getDueReportList({
    ...
    try {
      ...
      print(_response.body);
      if (_response.statusCode == 200) {
        final data = DueReportModel.fromJson(jsonDecode(_response.body));
