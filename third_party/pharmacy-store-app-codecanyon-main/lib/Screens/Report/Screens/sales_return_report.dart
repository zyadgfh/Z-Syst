...
class SalesReturnReport extends StatefulWidget {
  ...
  @override
  State<SalesReturnReport> createState() => _PurchaseReportState();
}

class _PurchaseReportState extends State<SalesReturnReport> {
  num totalQuantity = 0;
  num totalAmount = 0;

  // ---Controllers
  final ScrollController _scrollController = ScrollController();
  final PagingController<int, SaleReturnData> pageController = PagingController(firstPageKey: 1);
  ...
  Future<void> fetchSalesDataList(int pageKey) async {
    SaleReturnReportModel? list;
    try {
      list = await purchases.getSalesReturnReportList(
      ...
      if (list != null) {
        ...
        totalAmount = list.totalReturn ?? 0;
            ...
            slivers: [
                        ...
                        Row(
                          ...
                          children: [
                            ContainerWithLabel(
                              ...
                              label: '$currency${totalAmount.toStringAsFixed(2)}',
              ...
              SliverToBoxAdapter(
                child: PagedListView(
                  ...
                  builderDelegate: PagedChildBuilderDelegate<SaleReturnData>(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: '$currency${item.sale?.totalAmount ?? '0.0'}',
                                            style: theme.textTheme.bodyMedium?.copyWith(
                                              color: kNutrals900,
                                              fontWeight: FontWeight.w500,
                                            ),
                                ...
                                Row(
                                  children: [
                                    RichText(
                                      text: TextSpan(
                                        text: item.sale?.party != null ? item.sale?.party?.name.toString() ?? 'n/a' : 'Guest',
                                        style: theme.textTheme.bodyMedium?.copyWith(color: kNutral600),
                                      ),
                                    ),
                                    Spacer(),
