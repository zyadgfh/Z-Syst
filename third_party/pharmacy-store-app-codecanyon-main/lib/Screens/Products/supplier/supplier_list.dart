...
import 'package:mobile_pos/Screens/Products/supplier/add_new_supplier.dart';
import 'package:mobile_pos/Screens/Products/supplier/edit_supplier.dart';
...
class SupplierList extends StatefulWidget {
  const SupplierList({super.key, required this.isFromProductList});
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        const AddSupplier().launch(context);
                      },
                      child: Container(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          IconButton(
                                              ...
                                              padding: EdgeInsets.zero,
                                              onPressed: () async {
                                                bool confirmDelete = await showDeleteAlert(context: context, itemsName: 'Supplier');
                                                if (confirmDelete) {
                                                  EasyLoading.show();
