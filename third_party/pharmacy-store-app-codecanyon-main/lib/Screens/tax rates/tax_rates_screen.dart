                                      ...
                                      (index) => DataRow(
                                          ...
                                          DataCell(
                                            Center(
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: (singleTaxes[index].status ?? false) ? Colors.green.withOpacity(0.2) : Colors.red.withOpacity(0.2),
                                        ...
                                        color: WidgetStateColor.resolveWith(
                                          (Set<WidgetState> states) {
                                            return index % 2 != 0 ? kTextFiledBorder.withOpacity(0.1) : Colors.white;
                                          },
                                        ),
                                      ),
                                    ),
                                          ...
                                          DataCell(
                                            Center(
                                              child: Container(
                                                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                                decoration: BoxDecoration(
                                                  color: (groupTaxes[index].status ?? false) ? Colors.green.withOpacity(0.2) : Colors.red.withOpacity(0.2),
                                                  borderRadius: BorderRadius.circular(12),
                                                ),
                                                child: Text(
