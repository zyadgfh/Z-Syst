  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, __) {
      ...
      return AcnooScafoldWidget(
        ...
        appBar: AppBar(
          title: Text(
            widget.category != null ? _lang.editCategory : _lang.addCategory,
                  ...
                  child: TextFormField(
                    validator: (value) {
                      if (value?.trim().isEmptyOrNull ?? true) {
                        ...
                        return _lang.enterIncomeCategoryName;
                      }
                      return null;
                    },
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: _lang.enterCategoryName),
                  ),
                ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    if (key.currentState?.validate() ?? false) {
                      EasyLoading.show(status: '${_lang.saving}...');
