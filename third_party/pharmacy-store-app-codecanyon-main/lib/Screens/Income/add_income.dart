      ...
      builder: (context, ref, __) {
        ...
        return AcnooScafoldWidget(
          ...
          appBar: AppBar(
            ...
            title: Text(
              widget.income != null ? _lang.editIncome : _lang.createIncome,
                    ...
                    child: Column(
                      children: [
                          ...
                          data: (dataList) {
                            ...
                            return TextFormField(
                              ...
                              controller: TextEditingController(
                                text: selectedCategory?.categoryName ?? _lang.selectACategory,
                              ),
                              onTap: () async {
                              ...
                              decoration: InputDecoration(
                                floatingLabelBehavior: FloatingLabelBehavior.always,
                                labelText: _lang.incomeCategory,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: _lang.incomeDate,
                            hintText: _lang.enterIncomeDate,
                    ...
                    if (validateAndSave()) {
                      if (selectedCategory != null) {
                        ...
                        try {
                          ...
                          EasyLoading.showSuccess(_lang.savedSuccessFully);
