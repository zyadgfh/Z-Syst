              ...
              children: [
                ...
                Center(
                  child: CupertinoAlertDialog(
                    title: Text(
                      '${lang.exit}!!',
                      style: _theme.textTheme.titleLarge?.copyWith(color: Colors.red),
                    ),
                    ...
                    actions: [
                      CupertinoDialogAction(
                        ...
                        child: Text(
                          lang.no,
                          style: _theme.textTheme.bodySmall?.copyWith(color: Colors.red),
                        ),
                      ),
                      CupertinoDialogAction(
                        onPressed: () {
                        ...
                        child: Text(
                          lang.yes,
                          style: _theme.textTheme.bodySmall?.copyWith(color: kMainColor),
                        ),
                      ),
                    ],
                  ),
