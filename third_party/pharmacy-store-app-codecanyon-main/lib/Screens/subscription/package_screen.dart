        ...
        data: (info) {
          return AcnooScafoldWidget(
            appBar: AppBar(
              ...
              title: Text(l.S.of(context).yourPack, style: _theme.textTheme.titleLarge?.copyWith(color: Colors.white)),
              centerTitle: true,
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                title: Text(nameList[i], style: _theme.textTheme.titleMedium),
                                trailing: Text(
