            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        <h4>{{ __('Leave List') }}</h4>
                        <a type="button" href="#leaves-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new Leave') }}</a>
                    </div>
                    <div class="table-top-form p-16-0">
                        <div  class="d-flex align-items-center gap-1 flex-wrap">
                            <form action="{{ route('hrm.leaves.filter') }}" method="post" class="filter-form" table="#leaves-data">
                                @csrf
