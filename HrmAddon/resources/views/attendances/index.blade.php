            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#attendances-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i
                                class="fas fa-plus-circle me-1"></i>{{ __('Add new Attendance') }}</a>
                    </div>
                    <div class="table-top-form p-16-0">
                        <div  class="d-flex align-items-center gap-1 flex-wrap">
                            <form action="{{ route('hrm.attendances.filter') }}" method="post" class="filter-form"
                             ...
                             <form action="{{ route('hrm.attendances.filter') }}" method="post" class="filter-form" table="#attendances-data">
                                @csrf
