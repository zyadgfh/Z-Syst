            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#designations-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add Designation') }}</a>
                    </div>

                    <div class="table-top-form p-16-0">
                        <form action="{{ route('hrm.designations.filter') }}" method="post" class="filter-form" table="#designations-data">
                            @csrf
