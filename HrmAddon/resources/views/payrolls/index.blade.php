            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#payrolls-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new Payroll') }}</a>
                    </div>
                    <div class="table-top-form p-16-0">
                        <div  class="d-flex align-items-center gap-1 flex-wrap">
                            <form action="{{ route('hrm.payrolls.filter') }}" method="post" class="filter-form" table="#payrolls-data">
                                @csrf
                             ...
                             <form action="{{ route('hrm.payrolls.filter') }}" method="post" class="filter-form" table="#payrolls-data">
                                ...
                                <div class="table-top-left d-flex gap-3 margin-l-16">
                                    <div class="gpt-up-down-arrow position-relative d-print-none custom-date-filter">
                                        <select name="employee_id" class="form-control custom-days">
