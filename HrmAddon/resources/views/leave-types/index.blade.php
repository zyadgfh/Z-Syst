            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#leave-types-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add Leave Type') }}</a>
                    </div>
                    <div class="table-top-form p-16-0">
                        <form action="{{ route('hrm.leave-types.filter') }}" method="post" class="filter-form" table="#leave-types-data">
                            @csrf
