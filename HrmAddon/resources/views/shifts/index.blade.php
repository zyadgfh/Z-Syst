            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16">
                        <h4>{{ __('Shift List') }}</h4>
                        <a type="button" href="#shifts-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add new Shift') }}</a>
                    </div>
                    <div class="table-top-form p-16-0">
                        <form action="{{ route('hrm.shifts.filter') }}" method="post" class="filter-form" table="#shifts-data">
                            @csrf
