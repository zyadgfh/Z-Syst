...
select function_returns('public.api_post_sale_financial', ARRAY['bigint','bigint','bigint','text','text','numeric','numeric','numeric','jsonb','text','bigint'], 'sale financial API exists');
select function_returns('public.api_receive_purchase_financial', ARRAY['bigint','bigint','bigint','text','text','numeric','numeric','numeric','jsonb','text','bigint'], 'purchase financial API exists');
select function_returns('public.api_post_sale_return_financial', ARRAY['bigint','bigint','text','jsonb','text','bigint'], 'sale return financial API exists');
select function_returns('public.api_post_purchase_return_financial', ARRAY['bigint','bigint','integer','bigint','numeric','text','bigint'], 'purchase return financial API exists');
